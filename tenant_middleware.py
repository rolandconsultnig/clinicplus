"""
Tenant Isolation Middleware for MedConnect
Ensures proper data separation between healthcare facilities
"""

from functools import wraps
from flask import request, jsonify, g
from models.auth import UserRole, Role
from models.provider import Facility
...
class CrossFacilityAccess:
    ...
    def create_access_token(patient_id, source_facility_id, target_facility_id, 
        ...
        try:
            from models.clinical import CrossFacilityAccess as CFAModel
            import datetime
            ...
            access_token = CFAModel(
                ...
                expires_at=datetime.datetime.utcnow() + datetime.timedelta(hours=access_duration_hours),
                is_active=True
            )
    ...
    def verify_cross_facility_access(patient_id, source_facility_id, target_facility_id):
        ...
        try:
            ...
            access_token = CFAModel.query.filter_by(
                ...
                CFAModel.expires_at > datetime.datetime.utcnow()
            ).first()
